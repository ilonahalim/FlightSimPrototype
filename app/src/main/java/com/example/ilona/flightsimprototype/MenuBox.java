...
public class MenuBox extends GvrActivity implements GvrView.StereoRenderer{
...
*/
    ...
    public void onSurfaceCreated(EGLConfig config) {
       ...
       // int cockpitFragmentShader = myShaderLoader.loadGLShader(GLES20.GL_FRAGMENT_SHADER, R.raw.cockpit_fragment);
        ...
        skyResources[0] = R.drawable.menu_right;//right
        skyResources[1] = R.drawable.menu_left;//left
        skyResources[2] = R.drawable.menu_top;//top
        skyResources[3] = R.drawable.menu_bottom;//bottom
        skyResources[4] = R.drawable.menu_back;//back
        skyResources[5] = R.drawable.menu_front;//front
